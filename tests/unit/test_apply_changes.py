...
def test_cell_range_modifications():
    ...
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(modified_ast) == "SUM(A1:A9)"
    assert str(original_ast) == "SUM(A1:A9)"
...
def test_function_modifications():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "AVERAGE(A1:A10)"
...
def test_function_outer_inner_modification():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "AVERAGE(A2:A9)"
...
def test_function_long_modification():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(A1:A9) + AVERAGE(B2:B9)"
...
def test_nested_composite_modifications():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(AVERAGE(A2:A6), A11)"
...
def test_nested_structural_changes():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "AVERAGE(SUM(A1:A5), A10)"
...
def test_mixed_modifications_and_structural_changes():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(A2:A9, MAX(B2:B6))"
...
def test_add_argument_right_to_simple_function():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(A1:A10, B1:B10)"
...
def test_add_argument_left_to_simple_function():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(B1:B10, A1:A10)"
...
def test_add_argument_to_nested_function():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(AVERAGE(A1:A10), B1)"
...
def test_add_multiple_arguments():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(A1:A10, B1, C1:C10)"
...
def test_add_complex_argument():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(A1:A10, AVERAGE(B1:B10))"
...
def test_add_argument_deep_nested_function():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(AVERAGE(A1:A10, MAX(B1:B10)), MIN(C1:C10))"
...
def test_add_nested_outer_function():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(AVERAGE(A1:A10))"
...
def test_remove_argument_to_simple_function():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(A1:A10)"
...
def test_remove_argument_deep_nested_function():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(AVERAGE(A1:A10, MAX(B1:B10)))"
...
def test_unary_left_addition():
    ...
    modified_ast = parse("-A1")
    changes = compare_asts(original_ast, modified_ast)
    original_ast = apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "-A1"
...
def test_binary_right_addition():
    ...
    changes = compare_asts(original_ast, modified_ast)
    apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "A1 + A2 + A3"
...
def test_complex_binary_right_addition():
    ...
    changes = compare_asts(original_ast, modified_ast)
    original_ast = apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(A1:A10) + 1"
...
def test_add_outer_function():
    ...
    changes = compare_asts(original_ast, modified_ast)
    original_ast = apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "SUM(A1)"
...
def test_add_outer_logical():
    ...
    changes = compare_asts(original_ast, modified_ast)
    original_ast = apply_changes_to_ast(original_ast, changes, user_id="test")
    assert str(original_ast) == "NOT(A1)"
