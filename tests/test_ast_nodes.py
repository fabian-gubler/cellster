# test_ast_nodes.py
import pytest
from parser.ast_nodes import Cell, CellRange, Name, Function, Number, Logical, Binary, Unary
...
def test_cell_range_content_comparison(start, end):
    range1 = CellRange(Cell(*start, "user1"), Cell(*end, "user1"), "user1")
    range2 = CellRange(Cell(*start, "user1"), Cell(*end, "user1"), "user1")
